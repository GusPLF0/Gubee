package com.gusplf.springwebfluxessentials.exception;
...
public class GlobalExceptionHandler extends AbstractErrorWebExceptionHandler {
    ...
    public GlobalExceptionHandler(ErrorAttributes errorAttributes, WebProperties resources, ApplicationContext applicationContext) {
